...
class FrameReader(threading.Thread):
    ...
    def run(self):
        while self._running:
            ...
            frame = noparkingdtn(frame)
            #cv2.putText(frame, "Never Ever give Up",(30,20),cv2.FONT_HERSHEY_SIMPLEX,0.5,(255,255,255),2)
            #cv2.putText(frame, "Got the idea to alter the camera frame",(200,20),cv2.FONT_HERSHEY_SIMPLEX,0.5,(255,255,255),2)
            while self.queues:
